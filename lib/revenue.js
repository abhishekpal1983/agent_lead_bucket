...
const KEYS = ["revenue", "enrolments", "queue", "due", "done", "missed", "overdue", "uncalled",
  ...
  // Call Now 2.0's own timings and reasons, so Revenue Command can show the same
  // buckets the floor is working rather than a translation of them.
  "nofu", "fresh", "refill", "ifc",
  "queueT", "formT", "scoreT", "intlT", "needsT", "overdueT",
  "nofuT", "freshT", "refillT", "ifcT", "dueT"];
